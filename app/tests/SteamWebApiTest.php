...
/**
 * Class SteamWebApiTest
 * @group SteamWebApi
 */
class SteamWebApiTest extends TestCase {

	/**
	 * @return \Icy\Steam\Web\ISteamWebAPI
	 */
	public function getISteamWebApiInstance()
	{
		$webApi = $this->app->make('Icy\Steam\Web\ISteamWebAPI');
		$this->assertInstanceOf('\Icy\Steam\Web\ISteamWebAPI', $webApi);
